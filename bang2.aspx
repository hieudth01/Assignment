    	...
    	<div class="section group">
			...
			<h2>Assignnment</h2>
				...
				<div class="desc span_3_of_2">
					<h2 style="color:violet">BẢNG PURCHASE-ITEM</h2>
		            <p>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [purchase_item] WHERE [id] = @id" InsertCommand="INSERT INTO [purchase_item] ([id], [purchase_id], [product_id], [amount]) VALUES (@id, @purchase_id, @product_id, @amount)" SelectCommand="SELECT [id], [purchase_id], [product_id], [amount] FROM [purchase_item]" UpdateCommand="UPDATE [purchase_item] SET [purchase_id] = @purchase_id, [product_id] = @product_id, [amount] = @amount WHERE [id] = @id">
                            <DeleteParameters>
