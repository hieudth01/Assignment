			...
			<h2>Assignnment</h2>
				...
				<div class="desc span_3_of_2">
		            ...
		            <p>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [user] WHERE [id] = @id" InsertCommand="INSERT INTO [user] ([id], [full_name], [email]) VALUES (@id, @full_name, @email)" SelectCommand="SELECT [id], [full_name], [email] FROM [user]" UpdateCommand="UPDATE [user] SET [full_name] = @full_name, [email] = @email WHERE [id] = @id">
                            <DeleteParameters>
